...
class Config:
    ...
    beam_width: int = 4
    num_iterations: int = 40 #40
    lookahead: int = 0
    min_step_tokens: int = 10
    replace_broken_beams: bool = True
    ...
    #Scoing params
    novelty_bonus: float = 0.1 #Novelty score
    gamma: float = 0.05 # Uncertainty score
    lambda_: float = 0.2

    force_response: str = "\n**Final Answer**\n"
    check_prob_answer: str = None

    def __post_init__(self):
        if self.approach == "dvts" or self.approach == "dvts4" or self.approach == "dvts5":
        ...
        if self.push_to_hub:
            ...
            if self.approach == "beam_search" or self.approach == "dvts" or self.approach == "dvts4" or self.approach == "dvts5":
